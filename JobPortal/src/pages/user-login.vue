        ...
        <div class="bg-white dark:bg-gray-800 p-8 md:p-12 shadow-sm rounded-2xl w-full max-w-md mx-auto flex flex-col gap-8">
            <div class="flex flex-col items-center gap-4">
                ...
                <div class="flex flex-col items-center gap-2 w-full">
                    <div class="text-gray-900 dark:text-white text-2xl font-semibold leading-tight text-center w-full">Welcome Back</div>
            ...
            <div class="flex flex-col gap-6 w-full">
                <div class="flex flex-col gap-2 w-full">
                    <label for="email1" class="text-gray-900 dark:text-white font-medium leading-normal">Email Address</label>
